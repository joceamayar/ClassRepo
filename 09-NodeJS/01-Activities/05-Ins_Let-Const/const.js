...
// Const prevents from changing the values of primitive types such as " strings", nubers, boleand, ... However when using Const in Objects or Arraya we can modify the information inside them but can't redefine the object or the array. 